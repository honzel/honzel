...
@Documented
@BusinessProcessor
@ProcessorAttributesMapping(MaskProcessorAttributesMapper.class)
public @interface MaskBusinessProcessor {
     ...
     * 指定mask高位
     */
    int[] high() default ChainConstants.CHAIN_TYPE_DEFAULT;
    /**
     * 指定mask低位
     */
