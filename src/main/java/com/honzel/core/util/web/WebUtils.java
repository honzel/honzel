...
public class WebUtils {
    ...
    static {
        try {
        	...
        	LOG.warn("initialize SocketFactory fail!");
        }
    ...
    public static String doPost(String url, String content, Charset charset, int connectTimeout, int readTimeout, Map<String, Object> headerMap) throws IOException {
        ...
        HttpURLConnection conn = getConnection(url, METHOD_POST, contentType, connectTimeout, readTimeout, headerMap);
    ...
    public static String doGet(String url, String params, Map<String, Object> headerMap) throws IOException {
    	...
    	HttpURLConnection conn = getConnection(buildGetUrl(url, params), METHOD_GET, contentType, CONNECT_TIMEOUT, READ_TIMEOUT, headerMap);
		return doRequest(conn, null, DEFAULT_CHARSET);
    }
    ...
    public static String doGet(String url, String params, Charset charset, int connectTimeout, int readTimeout, Map<String, Object> headerMap) throws IOException {
        ...
        HttpURLConnection conn = getConnection(buildGetUrl(url, params), METHOD_GET, contentType, connectTimeout, readTimeout, headerMap);
     ...
     * @return 返回连接
     */
    public static HttpURLConnection getConnection(String url, String method, String contentType, int connectTimeout, int readTimeout, Map<String, Object> headerMap) {
    	HttpURLConnection conn = null;
    	try {
     ...
     * @return 返回连接
     */
	public static HttpURLConnection getConnection(String url, String method, String contentType) {
     ...
     * @return 返回连接
     */
	public static HttpURLConnection getConnection(String url, String method, String contentType, Map<String, Object> headerMap) {
    ...
    public static String buildQuery(Map<String, Object> textParams, Charset charset) {
        return buildQuery(textParams, charset, (String[]) null);
    }
    ...
    public static String buildQuery(Map<String, Object> textParams, Charset charset, String... ignoreKeys) {
        ...
        for (Entry<String, Object> entry : entries) {
            ...
            if (ignoreKeys != null && TextUtils.indexOf(ignoreKeys, key, 0) >= 0) {
                // 忽略的key
                continue;
            }
    ...
    private static String getStreamAsString(InputStream input, Charset charset, String contentEncoding) throws IOException {
        try {
    ...
    private static Charset getResponseCharset(String contentType) {
    ...
    public static String decode(String value, Charset charset) {
        if (!TextUtils.isEmpty(value) && charset != null) {
            try {
